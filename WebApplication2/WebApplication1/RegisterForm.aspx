...
<body>
     <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="RegisterPage"></asp:Label>
        </div>
        <p>
         ...
         <p>
            ...
            <asp:TextBox ID="TextBox3" runat="server" style="margin-left: 142px; margin-bottom: 0px"></asp:TextBox>
        </p>
